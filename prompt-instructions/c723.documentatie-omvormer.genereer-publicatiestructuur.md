...
Voer de intent `genereer-publicatiestructuur` uit voor de agent `documentatie-omvormer` op basis van onderstaande input en kaders uit grondslagen, beleid, charter en contract.
